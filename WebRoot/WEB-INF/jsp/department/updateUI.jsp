            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <!-- 
                    	...
                    	后台代码中把department对象放入到了map中，所以访问department必须加#,
                    	s:iterator特殊
                     -->
                     	<!-- 
                        <td><s:textfield name="dname" value="%{#department.dname}" cssClass="InputStyle"></s:textfield></td>
                    	 -->
                    	 <td><s:textfield name="dname"  cssClass="InputStyle"></s:textfield></td>
                    </tr>
                    <tr><td>职能说明</td>
                    	<!-- 
                        <td><s:textarea name="description" value="%{#department.description}" cssClass="TextareaStyle"></s:textarea></td>
                    	 -->
